...
public class StandardGameTest {
	public static void main(String args[]){
		...
		double generalScore = lookup.getScore(payoffMatrix);
		long generalScoreTime = (System.nanoTime() - startTime) / 1000000;
		startTime = System.nanoTime();
		double generalDScore = doubleLookup.getScore(payoffMatrix);
		...
		StandardGame game = new StandardGame(10, payoffMatrix);
